...
class SimpleButtonBox extends ButtonBox {
	...
	createWindow(ByRef window, ByRef windowWidth, ByRef windowHeight) {
		...
		Gui SBB:Add, Picture, x33 y60 w54 h85 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Toggle Switch.png"
		Gui SBB:Add, Picture, x137 y60 w54 h85 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Toggle Switch.png"
		Gui SBB:Add, Picture, x241 y60 w54 h85 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Toggle Switch.png"
		Gui SBB:Add, Picture, x345 y60 w54 h85 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Toggle Switch.png"
		Gui SBB:Add, Picture, x449 y60 w54 h85 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Toggle Switch.png"
		Gui SBB:Add, Picture, x40 y196 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x40 y284 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x144 y196 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x248 y196 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x352 y196 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x144 y284 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x248 y284 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x352 y284 w40 h40 BackgroundTrans, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
