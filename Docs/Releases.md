## 5.6.2.0-release 03/08/24 (planned)
  ...
  13. [Experts Only] Team specific settings can now be assembled by a team manager and can be imported by every team member in "Simulator Setup" using a special preset. Please take a look at the [new documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#managing-common-team-settings) for more information how to assemble such a package.
  14. [Experts Only] Special logging has been implemented which helps when tracking down startup performance problems. It can be activated in the [core settings](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Core-Configuration).
