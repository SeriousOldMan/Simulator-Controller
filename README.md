...
[3.6.2-rc1](https://www.dropbox.com/s/66lbt4gqvhupvgo/Simulator%20Controller%203.6.2-rc1.zip?dl=1) (Release candidate for Release 3.6.2. New features: Saving and loading of Strategies in "Strategy Workbench", Initializing values in "Strategy Workbench", Comparison of strategies in "Strategy Workbench", Take pitstop rules into account in strategy simulations. Stable, with update procedure and documentation.)
