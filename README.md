...
[7.2.2.0-release](https://cutt.ly/4yg2ZtVe) (Changes: Updated R3E car meta data, Race motivation support by the Driving Coach, Updated and added car meta data for AMS2, Fixed lap-based tyre change, Support for Piper TTS, Fixed Data redraw in "Solo Center", Disable unavailable voice options during configuration, Fixed repair requests for LMU, Fixed meta data for 296 EVO.)
