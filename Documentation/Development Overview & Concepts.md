...
To be as flexible as possible, plugins may be configured by the setup tool (*) and can define a set of [parameters](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#hasargumentparameter), which can be supplied with values in the configuration. See the documentatio for the included plugins, to get an understanding about plugin arguments.
