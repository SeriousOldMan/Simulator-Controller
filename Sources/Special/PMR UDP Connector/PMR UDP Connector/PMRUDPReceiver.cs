...
namespace PMRUDPReceiver
{
    public class PMRUDPReceiver
    {
        ...
        public bool HasReceivedData()
        {
            lock (dataLock)
            {
                return raceInfo != null && raceInfo.NumParticipants > 0 &&
                                           participantStates.Count == raceInfo.NumParticipants &&
                                           participantTelemetry.Count == raceInfo.NumParticipants;
            }
        }
    }
}
