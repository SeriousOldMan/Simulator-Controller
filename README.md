...
[7.2.3.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/cgFTIt_Q/Releases/Simulator%20Controller%207.2.3.0-dev.zip) (Early build for 7.2.3. Changes: Support for ACE setup files, Filter for unknown LMU cars in database synchronization, Filter for unknown LMU tracks in database synchronization, Migrated to AHK 2.1-Alpha.31, Added ACE cars for Setup Workbench", Added tyre data for new ACE cars, Performance improvement for standings computations, New car models for "Setup Workbench", Updated R3E car data.)
