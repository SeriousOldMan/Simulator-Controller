...
[5.9.1.0-dev](https://www.dropbox.com/scl/fi/awv4ti5wh7d2fgxbt7r4k/Simulator-Controller-5.9.1.0-dev.zip?rlkey=9ljkxpitc6it4qy0isn1cd2z8&st=jsv3br2l&dl=1) (Early build for 5.9.1. Changes: Open telemetry in the "Session Database", Telemetry Browser for "Team Center", Optimized database performance, Full translation for the Italian language, Fixed memory runaway in changing weather, Added a credits page in the documentation.)
