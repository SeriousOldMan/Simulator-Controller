...
showSplash(image, alwaysOnTop := true, video := false) {
	...
	if !image {
		...
		if (extension = "GIF") {
			...
			html := "<html><body style='background-color: #000000; overflow: hidden; leftmargin=0; topmargin=0; rightmargin=0; bottommargin=0'><img src='" . image . "' width=780 height=438 border=0 padding=0></body></html>"
