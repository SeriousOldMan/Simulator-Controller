...
runAnalyzer(commandOrAnalyzer := false, arguments*) {
	...
	if (commandOrAnalyzer == kCancel) {
		...
		Gui %window%:Add, Edit, x208 yp w45 h23 +0x200 HWNDwidget28 Number vtrackWidthEdit, % analyzer.TrackWidth
		Gui %window%:Add, UpDown, x238 yp w18 h23 Range1-999 HWNDwidget29, % analyzer.TrackWidth
