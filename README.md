...
| RF2 | Special support for starting and stopping rFactor 2 from your hardware controller. No special controller mode is defined for the moment, but an initial integration with Jona, the Virtual Race Engineer, is available since Releae 2.8. |
