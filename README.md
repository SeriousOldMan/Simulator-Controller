...
[6.2.6.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/erfjjr3K) (Test build for 6.2.6. Changes: Fixed several UTF encoding problems for driver names in the session database, Integrated Lua as scripting language, New core settings for folder locations, New resizing rules for "Strategy Workbech", Fixed several translation errors, Integration of scripts in "Strategy Workbench" and in the Assistant boosters, Higher priority for accident ahead in distance alerts by the Spotter.)
