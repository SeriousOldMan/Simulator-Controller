...
class SimpleButtonBox extends ButtonBox {
	...
	createWindow(ByRef window, ByRef windowWidth, ByRef windowHeight) {
		...
		Gui SBB:Add, Picture, x40 y196 w40 h40 BackgroundTrans vbutton1 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x40 y284 w40 h40 BackgroundTrans vbutton5 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x144 y196 w40 h40 BackgroundTrans vbutton2 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x248 y196 w40 h40 BackgroundTrans vbutton3 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x352 y196 w40 h40 BackgroundTrans vbutton4 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x144 y284 w40 h40 BackgroundTrans vbutton6 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x248 y284 w40 h40 BackgroundTrans vbutton7 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x352 y284 w40 h40 BackgroundTrans vbutton8 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Push Button.png"
		Gui SBB:Add, Picture, x455 y195 w42 h42 BackgroundTrans vdial1 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Rotary Dial 2.png"
		Gui SBB:Add, Picture, x455 y283 w42 h42 BackgroundTrans vdial2 gfunctionClick, % kButtonBoxImagesDirectory . "Photorealistic\Rotary Dial 2.png"
