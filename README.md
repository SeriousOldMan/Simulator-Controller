...
[6.2.2.0-dev](https://www.dropbox.com/scl/fi/5cwxnyysdb4nlaulkqab6/Simulator-Controller-6.2.2.0-dev.zip?rlkey=0iwow6kauzowsnno1m8salgig&st=9uj8dvzn&dl=1) (Early build for 6.2.2. Changes: Use rephrasing booster also for split talking, Updated Rephrasing booster instructions, Chat mode support for rFactor 2 and Le Mans Ultimate, Use Second Monitor as real time telemetry provider, Telemetry provider setting for Driving Coach, Choose telemetry provider in Team Center, Choose telemetry provider in Telemetry Viewer, First part of portoguese translations, Use local temp folder for installation packages, Private session function in Startup Profiles, Updated R3E car meta data, Interpolate missing telemetry values, Saving sesssion in "Solo Center" with session type, Fixed track automation for LMU and rF2, Fixed rF2 race number parsing.)
