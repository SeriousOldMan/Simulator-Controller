...
## 6.2.2.0-release 03/07/25 (planned)
  ...
  6. It is now possible to configure the application *Second Monitor* as the source for real time telemetry data. See the [extended documentation](*) on information about how to configure a connection between Simulator Controller and *Second Monitor*.
  ...
  10. Thanks to our community member @Hudson Alves, this release comes with the first part of the translations for the Portoguese language.
