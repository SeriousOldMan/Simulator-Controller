...
[6.9.9.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/bnHH8iVe/Releases/Simulator%20Controller%206.9.9.0-beta.zip) (Test build for 6.9.9. Changes: Fixed session settings translations for Chinese, Tyre wear balance thresholds for Race Engineer, More support for composite variables in hybrid rules, Spotter does not announce a problem for pitted cars anymore, Fixed message box icons background color, Prevent early pitstops from being registered, Fixed iRacing pitstop setting handling, Fixed database synchronization.)
