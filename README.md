...
[7.1.2.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/ulzdhJJ9/Releases/Simulator%20Controller%207.1.2.0-dev.zip) (Early build for 7.1.2. Changes: Tool calling for LLM Runtime, New core settings for the LLM Runtime, Answer post processing for the booster.)
