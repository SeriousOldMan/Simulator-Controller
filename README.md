...
[7.2.4.0-dev]() (Early build for 7.2.4. Changes: Support for multiple unit sets, Fixed premature end of LMU sessions, Fixed strategy for restricted tyres and retricted laps, Fixed spring rate for ACE BMW M4, New cars models for "Setup Workbench".)
