...
| openRaceCenter | - | Race Engineer, Race Strategist | Opens the "Race Center" tool, with which you can analyze the telemetry data of a running team session, plan and control pitstops and change race strategy on the fly. |
