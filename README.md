...
[6.1.5.0-beta](https://www.dropbox.com/scl/fi/zq0ekfizjdn32wlv80wep/Simulator-Controller-6.1.5.0-beta.zip?rlkey=e870om22vzcoen9lrlh8lhyat&st=4dd99cvg&dl=1) (Test build for 6.1.5. Changes: Fixed handling of team tab in "Race Settings", Fixed crash in "Setup Workbench" for special characters in car names, Fixed default for pitlane delta default value when not set, Up 2 date info for fuel, tyres and brakes by the Engineer, Fixed display of cold pressures in "Team Center" lap data, More checks in Controller layout editor, Special editor for validation rules in "Setup Workbench", Support for Inner, Middle and Outer tyre temperatures for iRacing, Real setup pressures are now used by the Engineer for iRacing, Fixed a bug in Azure voice recognition, Added Manifest Information, Increased reliability of shared memory connectors.)
