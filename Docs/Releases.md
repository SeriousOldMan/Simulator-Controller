## 6.1.4.0-release 01/31/25 (planned)
  ...
  6. A lot of fine-tuning for the recently added rule-based strategy handling.
  7. All Spotter announcements from the "Tactical Advices" group do not interrupt announcements of other Assistants anymore.
