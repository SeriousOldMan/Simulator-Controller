...
[6.8.7.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/BugfuWwN/Releases/Simulator%20Controller%206.8.7.0-dev.zip) (Early build for 6.8.7. Changes: Click sound for launch icons in "Simulator Startup", New core setting for Windows design modus, Clarified *Verbose* setting in the *core settings*, Added Polish Grammars, Progress bar during translation update.)
