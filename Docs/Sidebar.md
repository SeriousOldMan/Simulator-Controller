...
------
  ...
  - [Interacting with Aiden](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Driving-Coach#interacting-with-aiden)
    - [Telemetry-based coaching](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Driving-Coach#corner-by-corner-coaching-based-on-telemetry)
...
------
  ...
  - [Interacting with Jona](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Engineer#interacting-with-jona)
	...
	- [Extending capabilities with an LLM](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Engineer#extending-conversation-and-reasoning-capabilities-using-an-llm)
...
------
  ...
  - [Interacting with Cato](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Strategist#interacting-with-cato)
	...
	- [Extending capabilities with an LLM](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Strategist#extending-conversation-and-reasoning-capabilities-using-an-llm)
...
------
  ...
  - [Interacting with Elisa](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Spotter#interacting-with-elisa)
	...
	- [Extending capabilities with an LLM](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Spotter#extending-conversation-and-reasoning-capabilities-using-an-llm)
