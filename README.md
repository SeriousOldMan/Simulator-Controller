...
[4.5.2.1-alpha](https://www.dropbox.com/s/jn599b172bxd7in/Simulator%20Controller%204.5.2.1-alpha.zip?dl=1) (Stable test build for 4.5.2. New features: Integrated iRacing for the telemetry analyzer of "Setup Advisor", Updated oversteer detection algorithm, New calibration mode for telemetry analyzer, Optimized handling of tyre pressures for multiple drivers in the "Session Database", Support for tyre pressure meta data, Load tyre pressure setups in "Race Center" from the "Session Database", New car models for "Setup Advisor".)
