...
[3.5.6-dev]() (Early build for Release 3.5.6. New features: New Reports in Race Reports tool, Improved "Pace" report including median and quartile calculation, New "Call" command for Race Assistants, Better handling of multiple voice dialog partners when not using Push-to-Talk. Stable, with documentation and update procedure.)
