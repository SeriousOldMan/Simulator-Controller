...
[6.8.7.0-dev]() (Early build for 6.8.7. Changes: Click sound for launch icons in "Simulator Startup", New core setting for Windows design modus, Clarified *Verbose* setting in the *core settings*, Added Polish Grammars.)
