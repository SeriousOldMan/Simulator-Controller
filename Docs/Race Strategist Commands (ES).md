A continuación encontrará una lista completa de todos los comandos de voz reconocidos por Cato, el estratega de carrera AI, junto con una breve introducción a la sintaxis de las gramáticas de frases.
