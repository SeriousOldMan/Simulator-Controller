...
class HybridEngine extends Assert {
	...
	Function_Test() {
		...
		this.AssertEqual(42, kb.getValue("CallResult4"), "Unexpected external literal result...")
		this.AssertEqual(42, kb.getValue("CallResult5"), "Unexpected extern call result...")
