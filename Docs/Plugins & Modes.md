...
| [Automobilista 2](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-AMS2) | Also a small plugin in this list only supplies a special splash screem, when *Automobilista 2* is started. No special controller mode is defined for the moment. |
