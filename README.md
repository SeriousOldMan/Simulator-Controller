...
[5.4.3.0-dev](https://www.dropbox.com/scl/fi/xolo6bim63gpgrj88dykx/Simulator-Controller-5.4.3.0-dev.zip?rlkey=cj2pq3rul3q6iigop6ue0vatv&dl=1) (Early build for 5.4.3. Changes: New core settings to control window size constraints, Resized "Strategy Workbench", Extended "Pitstop" menu in "Race Center", Tyre set available in "System Monitor", Tyre set available in "Session State.json", Google TTS integration, New car models for "Setup Workbench".)
