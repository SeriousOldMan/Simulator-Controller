## 5.6.7.0-release 04/26/24 (planned)
  ...
  7. The warning issued by the Spotter has been optimized. The threshold of cuts and off-tracks is now dynamic and the warning has been rephrased.
  8. [Internal] Migrated to AHK 2.0.13.
  9. [Developer] Added a new generic class library for LLM support in preparation for the new Assistant GPT architecture.

## 5.6.8.0-release 04/19/24
  1. Minor bugfixes, as always
  2. Documentation updates here and there, as always
