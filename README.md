...
[6.0.2.0-beta](https://www.dropbox.com/scl/fi/0vndw1btx837qie8c7spc/Simulator-Controller-6.0.2.0-beta.zip?rlkey=803xx311u7i7vcbsap79nfvqb&st=v1ma19vb&dl=1) (Test build for 6.0.2. Changes: Renamed many parameters of the Assistant plugins, Automated detection of track sections, New function "On-track Coaching" for startup profiles, On-track coaching menu item in tray menu, Support for hotlap and time trial sessions, New controller action functions "startTelemetryCoaching" and "finishTelemetryCoaching", Fixed handling of deactivated voice recognizer, Suppress progress bar for auto export in "Solo Center", Coaching instructions are available in the "Session State.json" object, Fixed auto saving of sessions when auto exporting is enabled, Fixed Spanish grammars for Driving Coach.)
