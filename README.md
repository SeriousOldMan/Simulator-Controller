...
[7.2.0.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/uchfVZcz/Releases/Simulator%20Controller%207.2.0.0-dev.zip) (Early build for 7.2.0. Changes: Fixed missing info file when importing laps into the telemetry viewer, Fixed coordinate system for Second Monitor connector, New Setup Engineer in the "Setup Workbench", New workbench diary.)
