...
3. コーチング
	...
	[{コーチング, コーチングレッスン}をお願いします, {コーチング, トレーニング, 練習}セッションをしましょう, {トレーニング, 練習}を手伝ってください, 私の{トレーニング, 練習, 走り}を{見ていて, チェックして}ください, 私のドライビング{テクニック, スタイル}を{チェック, 確認}してください, ドライビングスキルを改善しましょう]
	...
	[{コーナーナンバー, (Number)番コーナー}に{集中しましょう, ついて話しましょう}, {コーナーナンバー, (Number)番コーナー}を{詳しく見てください, 確認してください}, {コーナーナンバー, (Number)番コーナー}で改善できる点はどこですか, {コーナーナンバー, (Number)番コーナー}で考慮すべきことは何ですか]
	...
	[{(Number)番コーナー, コーナー}に{集中しましょう, 練習しましょう}, {(Number)番コーナー, コーナー}を{集中して練習しましょう}, {(Number)番コーナー, コーナー}の{アドバイス, ヒント, ガイド, 指示}をください]

	[{もう一度トラック全体に, トラック全体に}集中しましょう]	
