			...
			try {
				...
				if tyreService {
					if (tyreService = "Wheel") {
						...
						pitstop["TyreChange"] := (knowledgeBase.getValue("Pitstop.Planned.Tyre.Compound", false) ? kTrue : kFalse)
			...
			try {
				...
				if tyreService {
					if (tyreService = "Wheel") {
						...
						pitstop["TyreChange"] := (knowledgeBase.getValue("Pitstop." . nr . ".Tyre.Compound", false) ? kTrue : kFalse)
