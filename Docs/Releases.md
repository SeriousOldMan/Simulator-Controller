## 5.2.1.0-release 08/04/23 (planned)
  ...
  15. A new plugin "Interface" is available, which exposes the complete state of the Race Assistants to external applications using a JSON file, which is updated periodically. With this it is possible, for example, to create a dashboard for Simulator Controller in SimHub.
