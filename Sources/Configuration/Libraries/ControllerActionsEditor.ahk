...
class ControllerActionsEditor extends ConfiguratorPanel {
	...
	class ActionsWindow extends Window {
		...
		__New(editor) {
			...
			super.__New({Descriptor: "Plugin Actions Editor", Closeable: true, Resizeable: true, Options: "-MaximizeBox -MinimizeBox"})
		}
	...
	createGui(configuration) {
		...
		actionsGui.Add("Documentation", "x118 YP+20 w168 H:Center Center", translate("Labels && Icons")
		...
		actionsGui.Add("Text", "x16 yp+10 w90 h23 +0x200", translate("Language"))
		...
		actionsGui.Add("Text", "x16 yp+24 w90 h23 +0x200", translate("Plugin"))
...
class PluginActionsList extends ConfigurationItemList {
	...
	createGui(editor, configuration) {
		...
		window.Add("Text", "x16 y370 w90 Y:Move", translate("Label && Icon"))
