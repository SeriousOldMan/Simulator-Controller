...
using static LMUSHMProvider.LeMansUltimateConstants.LMUGamePhase;
using static LMUSHMProvider.LeMansUltimateConstants.LMUPitState;
	...
	public class SHMProvider {
		...
		public void ReadData() {
			...
			if (connected && (playerTelemetry.mWheels != null)) {
				...
				Console.Write("EnergyRemaining="); Console.WriteLine(playerTelemetry.mVirtualEnergy * 100);
