...
[6.9.8.0-release](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/4cmBMwcL/Releases/Simulator%20Controller%206.9.8.0-dev.zip) (Early build for 6.9.8. Changes: Support for general expressions in list predicates, Support for any term as external function result in the rule engine, New calling method for external functions in the rule engine, ProveAll loops in rule engine, Fixed build rule for ACE SHM Spotter.)
