...
[6.2.7.0-release](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/-WzAyz1U) (Early build for 6.2.7. Changes: Fixed translation of session type by Engineer for mixed language settings, Assistant.Speak uses Rephrasing booster, All new Rules Provider for Reasoning booster, Support for bi-directional calls between Rule Engine and Script Engine, Individual tyre life / laps per tyre compound in "Strategy Workbench" and "Race Settings", Strategy simulation now selects the best tyre compound mixture based on the number of laps in a stint, Fixed Drivers.CSV file, Support for time + 1 lap races in "Strategy Workbench", Engineer does understand time + 1 lap races, Fixed refuel calculation in lap races for the last stint.)
