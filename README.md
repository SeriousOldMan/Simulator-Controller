...
[5.5.1.0-release](https://cutt.ly/XwSfgai2) (Changes: Check for incomplete automatic update, Fixed post pitstop tyre set info in "Race Center" for ACC, Fixed display of pitstop service information in "Race Center", New display of pitstop time loss in "Race Center", Optimized application of pitstop preference in strategy recalculation, Added FrontBrake and RearBrake to "Simulator Setup", Sanity check after pitstop setup in ACC, "Edit Labels & Icons" now also available on the simulator page in "Simulator Setup", Detection of changed pitstop settings made outside the control of Simulator Controller, New car models for "Setup Workbench".)
