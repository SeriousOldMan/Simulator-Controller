...
[7.0.2.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/I-hzGAWS/Releases/Simulator%20Controller%207.0.2.0-beta.zip) (Test build for 7.0.2. Changes: Fixed strategy pickup by Strategist, Support for custom driver name patterns, Generic LLM connector now also supports non OpenAI style URLs.)
