...
#### Changes
  ...
  - OpenAIs high end reasoning GPT-5 models are now supported. GPT 5 is the perfect candidate for the new LAM-based pitstop planning method (see next change).
