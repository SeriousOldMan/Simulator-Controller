...
[5.8.5.0-release](https://www.dropbox.com/scl/fi/30781ecunolaewpbudgr5/Simulator-Controller-5.8.5.0-dev.zip?rlkey=m7zugey9pc3k7wa1712tsbib2&st=pc797974&dl=1) (Early build for 5.8.5. Changes: Optimized handling of unidentified tyre sets (like Wets) in the "Practice Center", Fixed weather related tyre change handling of Engineer and Strategist, External report windows for "Practice Center", Extensions folder for Assistant rules, Potentially fixed a bug with corrupt driver names in AMS2 and PCARS 2, Resizeable window for team manager in "Simulator Setup", Removed minimize control for modal windows.)
