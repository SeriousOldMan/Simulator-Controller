## 4.1.7-release 05/27/22 (planned)
  ...
  11. New report in "Race Reports" and "Race Center" with lap times for all laps and cars. See the 8Lap Times Report Part [extended documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Virtual-Race-Strategist#race-reports) for more information.
