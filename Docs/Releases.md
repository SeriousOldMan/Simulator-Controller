...
#### Fixes
  ...
  - Fixed several translations for the announcement of the front right tyre wear by the Race Assistant.
...
#### Changes
  ...
  - [Experts] Support for a key logger style detection of keyboard presses for *Push-to-Talk* in those cases where the simulator consumes all key presses unconditionally. See the  [core settings](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Core-Settings#voice-settings) for more information.
...
#### Changes
  ...
  - [Important] When starting "Team Center", the connection settings for the Team Server will be taken from the active Startup Profile, even if the "Team Center" has been started manually. The behavior will be the same as before in almost all cases. Only if you have an invalid Team Server connection configuration in the currently active Startup Profile, you will encounter problems.
...
#### Changes
  ...
  - [Experts] The controller action function [*execute*](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Action-Functions) can now handle arguments which are then passed to the external application or script.
...
#### Changes
  ...
  - [Experts] Once again comprehensive extensions of the integrated script engine:
...
#### Changes
  ...
  - [Experts] Several additions and enhancements for the integrated *Lua* scripting engine:
...
## 6.1.6.0-release 02/14/25
  ...
  14. [Experts] The meta information between <think> and </think> is now removed automatically from the answer, when models like deepseek-r1 are used.
...
## 6.1.5.0-release 02/07/25
  ...
  14. [Experts] A new version of the local LLM Runtime is available, which includes the latest Llama backend. Support for the deepseek v3 model is included, if you have 800 GB of memory in your machine :-)
...
## 6.1.4.0-release 01/31/25
  ...
  12. [Experts] "Simulator Startup" now supports the [integration of additional startup scripts](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#customizing-startup-configuration) to customize your environment when starting up Simulator Controller.
...
## 6.1.2.0-release 01/17/25
  ...
  15. A short sound is played now, whenever an Assistant action is triggered by the *Reasoning* booster. This helps to understand whether a given behavior is caused by a connected LLM.
  16. [Experts] The format of action definitions in the *Conversation* and in the *Reasoning* booster has changed. See the [revised documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Customizing-Assistants#managing-actions) for more information.
...
## 6.0.2.0-release 12/20/24
  ...
  12. [Experts] Many parameters of all Race Assistant plugins have been renamed. The old names are still supported for compatibility reasons, but they are deprecated.
  13. [Experts] Corner by corner instructions of the Driving Coach are now written to the "Session State.json" file which can be used to implement SimHub Dashboards and Overlays.
...
## 6.0.0.0-release 12/06/24
  ...
  8. [Experts] The *Reasoning* booster can now be used without a LLM, if you only want to extend the rule base of an Assistant. See the [updated documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Customizing-Assistants#reasoning-booster) for more information.
...
## 5.8.5.0-release 08/30/24
  ...
  8. "Practice Center" now also can [open every report in a separate window](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Solo-Center#notes), similar to the "Race Center" behavior introduced with Release 5.8.3. To open a report in a separate window, hold down the Control key while choosing the report.
...
## 5.7.3.0-release 05/24/24
  ...
  13. It is now possible to configure the instructions for the different GPT-based Conversation Boosters. Please take a look at the [updated documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Installation-&-Configuration#boosting-conversation-with-a-llm) for more information.
...
## 5.6.8.0-release 04/26/24
  ...
  4. Two new options "Auto Clear" and "Auto Export" in the "Session" menu of the "Practice Center" let you specify the behavior, when a new session is started or the application is closed with some unsaved / unexported data still present.
...
## 5.5.2.0-release 01/05/24
  ...
  7. [Experts] Clarified several aspects in the documentation about [car meta data definition](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Setup-Workbench#introducing-a-new-car) for "Setup Workbench".
  8. [Experts] New [EnumerationHandler](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Setup-Workbench#introducing-new-car-specifications) for car meta data definition in "Setup Workbench".
...
## 5.4.2.0-release 10/20/23
  ...
  12. The behavior of the "Treshold" choice for repairs in "Race Settings" has changed. Please see the [revised documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#tab-pitstop) for more information.
...
## 5.4.1.0-release 10/13/23
  ...
  4. Many functional additions to the Driving Coach.
	 ...
	 - The Driving Coach can use the Telemetry Analyzer of the "Setup Workbench" during a session to acquire information about any handling issues to give you precise and context aware coaching on driving behavior and possible car setup changes.
	 ...
	 - Extensive [documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#instructions) has been added which describes in detail how to use instructions to customize the behavior and personality of the Driving Coach to your personal taste.
...
## 5.0.7.0-release 06/06/23
  ...
  5. It is now possible to enable the [Monte Carlo traffic simulation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#adjusting-the-strategy-during-a-race) method, which has been [available in the "Race Center"](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Team-Center#strategy-handling) for quite some time, for the strategy simulation by the AI Race Strategist as well.
	 ...
	 - A couple of [new settings](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Session-Settings) in the "Session Database" allow you to fine tune the behavior of the probabilistic algorithm.
...
## 4.3.2.0-release 09/16/22
  ...
  15. A preset has been added to "Simulator Setup" to enable a toggle mode for the *Push-To-Talk* trigger. Please see the [revised documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#Push-To-Talk-behavior) for more information.
...
## 3.7.8-release 12/24/21
  ...
  9. Optimized Race Assistant behavior when no voice recognition is enabled - more interaction possible using hardware controller.
...
## 3.0.6-release 05/28/21
  ...
  1. Bugfixes, as always
  2. Documentation updates, as always
  3. A [new page in the configuration tool](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Installation-&-Configuration#tab-race-engineer) allows you to customize many aspects of the Race Engineer behavior and the integration of Jona with the setup database.
