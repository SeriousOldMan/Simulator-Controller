## 5.5.2.0-release 01/05/24 (planned)
  ...
  6. Clarified many party in the documentation about [car meta data definition](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Setup-Workbench#introducing-a-new-car) for "Setup Workbench".
