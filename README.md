...
[7.1.3.0-alpha]() (Test build for 7.1.3. Changes: External references in the rule engine, Suspension related issues in the issue analyzer, Suspension related issues detected by the Driving Coach, Changed default for data update frequency, Fixed startup crash in "Strategy Workbench".)
