...
[5.9.0.0-release](https://www.dropbox.com/scl/fi/83slo33ywxem2nzhwtxg7/Simulator-Controller-5.9.0.0-dev.zip?rlkey=rkg04bkxhm16qgcxzzwfzi6bt&st=zw4xpjsq&dl=1) (Early build for 5.9.0. Changes: Fixed lap times and sector times in RaceRoom Racing Experience, Removed brake ducts for R3E from "Setup Workbench", New browser for real time car telemetry, Updated "Light" theme colors.)
