## 2.7-release planned for 04/02/21 (2-week easter egg sprint)
  ...
  8. Plugin Interface for the configuration tool (no documentation yet, will follow with the next release)
  9. Added "No Refuel" to the set of handled pitstop configurations - please take a look at the [Update Notes](*) for more information
