...
[6.6.6.0-dev]() (Early build for 6.6.6. Changes: Fixed acoustic feedback for handling issues, Fixed continuous update of refuel amount for LMU, Fixed storing of Google API key in the configuration, Fixed negative track runnings in IRC, Fixed race reports for sessions with just one lap, New car models for Setup Workbench, Rearranged session state data acquisition.)
