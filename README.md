...
[6.3.2.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/FNPf2RfM) (Test build for 6.3.2. Changes: Optimized handling of restricted tyre sets in strategy simulation, Active handling of individual tyre compounds in many parts of Simulator Controller, Fixed data collection without "Solo Center", Fixed strategy simulation in "Team Center", Fixed stint statistics update in "Team Center", No display of all-zero infos in "System Monitor", New setting for pressure loss threshold in session settings, New setting for pressure loss threshold in "Race Settings", Migrated to AHK 2.1-alpha.18, Fixes to Spanisch translation.)
