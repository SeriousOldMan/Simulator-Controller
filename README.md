...
[5.7.2.0-beta](https://www.dropbox.com/scl/fi/cdj6q61iz0xds29nzglj9/Simulator-Controller-5.7.2.0-beta.zip?rlkey=i1sllmkq6xw0kyao6ehfwda6t&st=kjwyg7a7&dl=1) (Test build for 5.7.2. Changes: New telemetry instruction for the Driving Coach, General conversation capability for all Assistants using GPT technology, Fixed installation of French language pack, Conversation Booster configuration integrated in "Simulator Configuration", Added "Mistral AI" as GPT service provider, Fixed stint timer if larger than driver time, Added "GPT-4o" model entry, Test mode for Push-To-Talk, Added tyre pressure increments to session info page, Added tyre pressure increments to "Session State.json", Migrated to AHK 2.0.15.)
