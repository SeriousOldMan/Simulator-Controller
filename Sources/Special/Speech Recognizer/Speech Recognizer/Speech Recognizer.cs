...
namespace Speech
{
    public partial class SpeechRecognizer
    {
        ...
        /// <returns></returns>
        public string LoadGrammar(Grammar grammar, string name, dynamic callback)
        {
        ...
        public Grammar GetLoadedGrammar(string name)
        {
            return _loadedGrammarDictionary[name].Grammar;
        }
