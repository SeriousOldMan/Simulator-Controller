...
[6.1.5.0-dev](https://www.dropbox.com/scl/fi/f4wrx9vuscayb008sq71m/Simulator-Controller-6.1.5.0-dev.zip?rlkey=5l2q9pb8jn3akhacw1yp0r53e&st=00hmvzv2&dl=1) (Early build for 6.1.5. Changes: Fixed handling of team tab in "Race Settings", Fixed crash in "Setup Workbench" for special characters in car names, Fixed default for pitlane delta default value when not set, Up 2 date info for fuel, tyres and brakes by the Engineer, Fixed display of cold pressures in "Team Center" lap data, More checks in Controller layout editor, Special editor for validation rules in "Setup Workbench", Support for Inner, Middle and Outer tyre temperatures for iRacing, Real setup pressures are now used by the Engineer for iRacing.)
