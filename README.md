...
[4.2.0.0-beta](https://www.dropbox.com/s/4lrwsh5ly7dol32/Simulator%20Controller%204.2.0.0-beta.zip?dl=1) (Test build for 4.2.0.0. New features: Full support by the Race Engineer for Assetto Corsa, Basic support by the Race Strategist for Assetto Corsa, New "Pitstop" and "Assistant" modes for Assetto Corsa, Renamed and reordered settings in "Session Database", Changed grammar for lap time announcements, Changed grammar for the current sector in yellow flag announcements, Unnecessary yellow flag warnings are suppressed, R3E meta data update, Edit, compare and merge Assetto Corsa setups in "Setup Advisor", New car models for "Setup Advisor". Stable, incl. documentation updates.)
