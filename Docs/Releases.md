## 5.5.8.0-release 02/16/24 (planned)
  ...
  7. **Important:** When using the Azure or Google voice recognition services, it is no longer need to double-press the Push-To-Talk button to [initiate an activation command](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#voice-commands) like "Hey Jona".
