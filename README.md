...
[7.2.6.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/8o4UDzPl?inline=true) (Early build for 7.2.6. Changes: Fixed standings and gap calculation for iRacing, Potential fix for team session handover for LMU, Optimized telemetry startup in "Solo Center", Caching for track spline for ACC, Wildcard matching for setup settings in car rules, New car models for "Setup Workbench", Track data for LMU DLC.)
