...
[6.3.9.0-release](https://cutt.ly/3rTMGzzx) (Changes: New voice recognition support using a remote Whisper server, Correct brake pad wear for Le Mans Ultimate, Correct suspension damage for Le Mans Ultimate, Fixed suspension repair in Le Mans Ultimate.)
