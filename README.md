...
[6.9.6.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/vsx6uFMd/Releases/Simulator%20Controller%206.9.6.0-dev.zip) (Early build for 6.9.6. Changes: Rejectable installation of runtimes in "Simulator Setup", New Assistant Icons, Telemetry-based Issue Analyzer, Optimized naming of Session folders.)
