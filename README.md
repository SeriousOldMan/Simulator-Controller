...
[5.7.9.0-release]() (Changes: Initialize from Session now takes stint plan first in "Race Center", Adding and removing stints from the stint plan now runs a full plan update in "Race Center", Team Management tab in "Simulator Configuration" removed.)
