...
[5.6.6.0-alpha](https://www.dropbox.com/scl/fi/ybve9elys86i6zr1z7xqe/Simulator-Controller-5.6.6.0-alpha.zip?rlkey=88z8grggkg8a8drzvni6q9fby&dl=1) (Test build for 5.6.6. Changes: Fixed shared database synchronization, Added "Both" to "Spotter: Car Indicator" setting, Fixed iRacing practice session detection, "Car Indicator" setting also for the Stratgist, Increased trigger detection speed, Tweaked accident detection, Trigger detection now can also detect key presses on the keyboard.)
