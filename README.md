...
[7.1.1.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/LC4x7tgr/Releases/Simulator%20Controller%207.1.1.0-dev.zip) (Early build for 7.1.1. Changes: Updated F1 UDP integration for the 2026 DLC, Fixed driver names for rFactor 2, Optimized handling of fuel range controls in "Strategy Workbench", New suspension issues for "Setup Workbench", Fixed session start in F1 25/26.)
