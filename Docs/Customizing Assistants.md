...
| Attack Imminent             | 1. [Required] carNumber<br>2. [Required] delta | This event is signalled, when an opponent is closing in and an attack might happen soon. *carNumber* is the car or race number of the car closing in and *delta* is the current gap in seconds. |
