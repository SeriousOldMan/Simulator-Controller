...
### Main features
  ...
  - Several plugins are supplied out of the box:
    - Support for *Assetto Corsa*, *Assetto Corsa Competizione*, *rFactor 2* and *RaceRoom Racing Experience* already builtin, other simulation games will follow
...
| RF2 | Special support for starting and stopping rFactor 2 from your hardware controller. No special controller mode is defined for the moment, but an integration with Jona, the Virtual Race Engineer, including full support for automated pitstop handling is available since Releae 2.8. |
| R3E | Special support for starting and stopping RaceRoom Racing Experience from your hardware controller. No special controller mode is defined for the moment, but an initial integration with Jona, the Virtual Race Engineer, is available since Releae 2.8. |
