## 4.5.2.0-release 12/16/22 (planned)
  ...
  7. Ideal tyre pressures are now supported for dry and wet tyres in the car specific meta data. If this information is present, it is used rather and will supersede teh information entered in "Race Settings". You may however still overwrite it in the "Session Database".
