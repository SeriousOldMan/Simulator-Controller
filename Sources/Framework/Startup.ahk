...
initializeEnvironment() {
	...
	DirCreate(kUserHomeDirectory . "Garaga")
	DirCreate(kUserHomeDirectory . "Garaga\Definitions")
	DirCreate(kUserHomeDirectory . "Garaga\Rules")
	DirCreate(kUserHomeDirectory . "Garaga\Definitions\Cars")
	DirCreate(kUserHomeDirectory . "Garaga\Rules\Cars")
