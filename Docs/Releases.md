## 5.5.2.0-release 01/05/24 (planned)
  ...
  14. [Developer only] Information about the active startup profile has been added to the "Session State.json" file.
  15. [Developer only] Information about the pitstop forecast has been added to the "Session State.json" file.
  16. [Internal] Migrated to AHK version 2.0.11.
