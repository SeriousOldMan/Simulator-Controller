...
------
  ...
  - [Configuration](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Installation-&-Configuration#configuration)
    ...
    - [Controller](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Installation-&-Configuration#tab-controller)
      - [Action Functions](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Action-Functions)
	...
	- [Driving Coach](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Installation-&-Configuration#tab-driving-coach)
...
------
  ...
  - [Using Simulator Controller](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#using-simulator-controller)
    ...
    - [Voice Commands](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#voice-commands)
	  ...
	  - [Non-standard voice configurations](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Using-Simulator-Controller#non-standard-voice-configurations)
...
------
  ...
  - [Driving Coach](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-driving-coach)
  ...
  - [Race Spotter](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-race-spotter)
  ...
  - [IRC - iRacing](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-irc)
	...
	- [Notes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#special-notes-for-iracing)
  - [RF2 - rFactor 2](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-rf2)
    - [Chat](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#mode-chat-1)
	...
	- [Notes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#special-notes-for-rfactor-2)
  - [LMU - Le Mans Ultimate](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-lmu)
    - [Chat](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#mode-chat-2)
	...
	- [Notes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#special-notes-for-le-mans-ultimate)
  ...
  - [ACE - Assetto Corsa EVO](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-ace)
    - [Pitstop](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#mode-pitstop-9)
    - [Assistant](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#mode-assistant-9)
	- [Notes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#special-notes-for-assetto-corsa-evo)
...
------
  ...
  - [Telemetry Viewer](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Solo-Center#Telemetry-Viewer)
...
------
  ...
  - [Telemetry Viewer](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Team-Center#Telemetry-Viewer)
...
------
  - [Introduction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#introduction)
  - [Installation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#installation)
  - [Configuration](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#configuration)
    - [Instructions](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#instructions)
  - [Interacting with Aiden](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#interacting-with-aiden)
    - [List of all voice commands](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#list-of-all-voice-commands)
  ...
  - [Driver coaching](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#coaching-based-on-lap-telemetry-data)
	...
	- [Race motivation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Driving-Coach#motivation-on-the-track)
...
------
  - [Introduction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#introduction)
  - [Installation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#installation)
  - [Interacting with Jona](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#interacting-with-jona)
    - [List of all voice commands](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#list-of-all-voice-commands)
	- [Extending capabilities with a LLM](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#extending-conversation-and-reasoning-capabilities-using-a-llm)
  ...
  - [Racing with Jona](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#racing-with-jona)
	...
	- [Execute a Pitstop](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#the-pitstop)
    - [How it works](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#how-it-works)
  - [Technical Information](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#technical-information)
    - [Rule Engine](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#the-rule-engine)
	- [States & History](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#interaction-states)
	- [Telemetry Integration](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#telemetry-integration)
  - [Troubleshooting](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#troubleshooting)

[AI Race Strategist](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist)
------
  - [Introduction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#introduction)
  - [Installation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#installation)
  - [Interacting with Cato](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#interacting-with-cato)
    - [List of all voice commands](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#list-of-all-voice-commands)
	- [Extending capabilities with a LLM](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#extending-conversation-and-reasoning-capabilities-using-a-llm)
  ...
  - [Strategy Handling](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#strategy-handling)
	- [Recalculating the Strategy](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#adjusting-the-strategy-during-a-race)
	  - [Handling Full Course Yellow](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#handling-full-course-yellow)
  - [Technical Information](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#technical-information)
    - [Data acquisition](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#data-acquisition)
  - [Troubleshooting](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Strategist#troubleshooting)

[AI Race Spotter](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter)
------
  - [Introduction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#introduction)
  - [Installation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#installation)
  - [Interacting with Elisa](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#interacting-with-elisa)
    - [List of all voice commands](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#list-of-all-voice-commands)
	- [Extending capabilities with a LLM](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#extending-conversation-and-reasoning-capabilities-using-a-llm)
    - [Managing Announcements and Warnings](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#enabling-and-disabling-specific-warnings-and-announcements)
  - [Alerts & Information](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Spotter#alerts--information)
...
------
  ...
  - [Rule Engine](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine)
    - [Introduction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine#introduction)
	- [Reference](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine#rule-engine)
	  - [Knowledge Base](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine#knowledge-base)
	  - [Literals, expressions and terms](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine#literals-expressions-and-terms)
	  - [Production Rules](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine#production-rules-forward-chaining)
	  - [Reduction Rules](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Rule-Engine#reduction-rules-backward-chaining)
  ...
  - [Functions Reference](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference)
    - [Thread Protection](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#thread-protection-taskahk)
    - [Debugging & Logging](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#debugging-and-logging-debugahk)
    - [Type Helper](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#string-helper-functions-typesahk)
    - [String Helper](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#string-helper-functions-stringsahk)
    - [Collection Helper](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#collection-helper-functions-collectionsahk)
	- [Utility Functions](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#utiliy-functions-utilsahk)
    - [File Handling](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#file-handling-filesahk)
    ...
    - [Multi Map](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#multi-maps-multimapahk)
    - [Localization & Translation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#localization--translation-localizationahk)
    - [GUI Tools](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#gui-tools-guiahk)
    - [Splash Screens](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#splash-screens-splashahk)
    - [Progress Bar](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#progress-bar-progressahk)
    - [Message Box](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#message-box-messageahk)
    - [Tray Popups](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Functions-Reference#tray-popups-traymenuahk)
  ...
  - [Classes Reference](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference)
    - [GUI Classes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#gui-classes)
	  - [Window](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#window-guiahk)
	    - [Window.Resizer](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#abstract-class-windowresizer-guiahk)
    - [Collection Classes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#collections-classes)
	  - [CaseSenseMap](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#casesensemap-collectionsahk)
	  - [CaseInseneMap](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#caseinsensemap-collectionsahk)
	  - [WeakArray](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#weakarray-collectionsahk)
	  - [WeakMap](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#weakmap-collectionsahk)
	    - [CaseSenseWeakMap](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#casesenseweakmap-collectionsahk)
	    - [CaseInsenseWeakMap](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#caseinsenseweakmap-collectionsahk)
    - [Configuration Classes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#configuration-classes)
      - [ConfigurationItem](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#abstract-configurationitem-configurationahk)
      - [Application](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#application-extends-configurationitem-configurationahk)
      - [Function](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#abstract-function-extends-configurationitem-configurationahk)
      - [TwoWayToggleFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#twowaytogglefunction-extends-controllerfunction-configurationahk)
      - [OneWayToggleFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#onewaytogglefunction-extends-controllerfunction-configurationahk)
      - [ButtonFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#buttonfunction-extends-controllerfunction-configurationahk)
      - [DialFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#dialfunction-extends-controllerfunction-configurationahk)
      - [CustomFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#customfunction-extends-controllerfunction-configurationahk)
      - [Plugin](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#plugin-extends-configurationitem-configurationahk)
    - [Configuration Editor Classes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#configuration-editor-classes)
      - [ConfigurationEditor](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#singleton-configurationeditor-extends-configurationitem-simulator-multimapahk)
      - [ConfigurationItemList](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#abstract-configurationitemlist-extends-configurationitem-simulator-multimapahk)
    - [Controller Classes](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#controller-classes)
      ...
      - [ControllerTwoWayToggleFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#controllertwowaytogglefunction-extends-controllerfunction-simulator-controllerahk)
      - [ControllerOneWayToggleFunction](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Classes-Reference#controlleronewaytogglefunction-extends-controllerfunction-simulator-controllerahk)
