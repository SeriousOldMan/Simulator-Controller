## 5.2.2.0-release 08/11/23 (planned)
  ...
  12. [Developer] Additional information has been added to the ["Session State.json" file](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Plugins-&-Modes#plugin-integration) introduced with the last release.
  13. [Developer] The data format of the "Session State.json" file has been updated to better reflect the JSON data type standard.
