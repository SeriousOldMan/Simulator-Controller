...
#### Changes
  ...
  - The local LLM Runtime, which can be installed from a downloadable preset in "Simulator Setup", has been completely rewritten.
  ...
  - A new filter script allows you to post process the answers generated by LLMs and remove any unwanted text or other elements from the answer. See the [added documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Customizing-Assistants#answer-filter) for more information.
