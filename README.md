...
[6.2.4.0-release](https://cutt.ly/IroxA4e5) (Changes: New voice command to request engine temperatures, New information request action "EngineTemperatures" for the "Race Engineer" plugin, New icon in the Stream Deck icon set for engine temperatures, Fixed confirmation for on-track coaching, Next part of Portuguese translations, Fixed driver names for LMU, Driver categoriy support for LMU, Fixed various translations, Fixed News system.)
