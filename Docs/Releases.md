## 5.9.2.0-release 10/04/24 (planned)
  ...
  11. "Setup Workbench" now also supports collecting lap telemtry data. See the [added documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Setup-Workbench#telemetry-viewer) for more information. This is not yet supported for *Assetto Corsa Competizione* (will be added with the next release).
