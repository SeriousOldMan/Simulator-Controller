## 5.0.5.0-release 05/19/23 (planned)
  ...
  7. New stint length optimization rules based on data generated by machine learning have been included in the "Strategy Workbench".
  8. Fixed handling of *No tyre change* in pitstop preparation in "Race Center".
  9. Fixed handling of pitstop preparation in "Race Center", when no strategy has been selected.
