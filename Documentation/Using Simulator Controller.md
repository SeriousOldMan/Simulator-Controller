Using Simulator Controller is quite easy. The most difficult part will be the setup, but fortunately, this has to be done only once. Please see the extensive [Installation & Setup](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Installation-&-Setup) guide on more information about this task.
...
...too have some fun. If you like Simulator Controller and find it useful, I would be very happy about a small donation, which will help in further development of this software. Please see the [README](https://github.com/SeriousOldMan/Simulator-Controller/blob/main/README.md) for the donation link. Thanks and see you on the track...
