...
[7.2.2.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/j4ENrFpC/Releases/Simulator%20Controller%207.2.2.0-dev.zip) (Early build for 7.2.2. Changes: Updated R3E car meta data, Race motivation support by the Driving Coach, Updated and added car meta data for AMS2, Fixed lap-based tyre change, Support for Piper TTS.)
