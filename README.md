...
[3.1.0-beta](https://www.dropbox.com/s/lowiwkjlkm36laa/Simulator%20Controller%203.1.0-beta.zip?dl=1) (Stable build for Release 3.1.0. New features: Support for multiple Voice Assistants, Initial version of Race Strategist Assistant, New Race Strategist Plugin to control the Race Strategist, New Configuration Plugin for Race Strategist, Voice Management now allows for multiple voices even with multiple languages, Refactoring of several file locations (rules, translations, grammars). Quite stable incl. documentation and automated update procedure...)
