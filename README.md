...
[6.3.9.0-beta](http://simulator-controller.selfhost.co:800/api/public/dl/AVDRXbgm) (Test build for 6.3.9. Changes: New voice recognition support using a remote Whisper server, Correct brake pad wear for Le Mans Ultimate, Correct suspension damage for Le Mans Ultimate, Fixed suspension repair in Le Mans Ultimate.)
