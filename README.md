...
[3.6.8-rc1](https://www.dropbox.com/s/ufylh5p7ko1i2vu/Simulator%20Controller%203.6.8-rc1.zip?dl=1) (First release candidate for 3.6.8. New features: New editor for action labels and icons, Refactoring of the ButtonBoxEditor class, New editor for Stream Deck controller layouts, Updated "Simulator Setup" and "Simulator Configuration" to support the new editors, Revised online documentation for "Simulator Setup". Including update procedure and documentation.)
