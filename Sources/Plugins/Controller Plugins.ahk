...
#Include "Voice Control Plugin.ahk"				; Optional, but must be loaded directly after System Plugin
...
#Include "Driving Coach Plugin.ahk"				; Must be loaded before all other Race Assistant Plugins
