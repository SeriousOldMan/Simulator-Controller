...
| startBrakeCoaching | - | Driving Coach | Instructs the Driving Coach to give hints while you are driving where and how to brake. If *confirm* is supplied and *false*, no confirmation is given by the Driving Coach. |
