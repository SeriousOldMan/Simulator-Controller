...
[7.2.3.0-dev]() (Early build for 7.2.3. Changes: Support for ACE setup files, Filter for unknown LMU cars in database synchronization, Filter for unknown LMU tracks in database synchronization, Migrated to AHK 2.1-Alpha.31, Added ACE cars for Setup Workbench".)
