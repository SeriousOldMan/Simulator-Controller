...
## 6.2.1.0-release 02/28/25 (planned)
  ...
  16. [Important] The default value for the setting "Repeat whole voice message" has changed for all Assistants from *True* to *False*. This means, that an Assistant will only repeat the last sentence, if got interrupted by another Assistant. If you want to restore the *old* bahaviour, include the setting in the [race settings](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Race-Settings) in the "Session Database" for your simulators.
