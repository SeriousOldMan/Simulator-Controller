...
[5.7.2.0-alpha](https://www.dropbox.com/scl/fi/svzys7b76vu2jv1rhv49y/Simulator-Controller-5.7.2.0-alpha.zip?rlkey=0sw147evinbz5yu1lcqhhkar7&st=vibfsjvc&dl=1) (Test build for 5.7.2. Changes: New telemetry instruction for the Driving Coach, General conversation capability for all Assistants using GPT technology, Fixed installation of French language pack, Conversation Booster configuration integrated in "Simulator Configuration", Added "Mistral AI" as GPT service provider, Fixed stint timer if larger than driver time, Added "GPT-4o" model entry.)
