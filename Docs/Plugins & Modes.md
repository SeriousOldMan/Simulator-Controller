...
| R3E | Similar to the AC and RF2 plugins provides this plugin start and stop support for RaceRoom Racing Experience. No special controller mode is defined for the moment, but an integration with Jona, the Virtual Race Engineer, is available. |
