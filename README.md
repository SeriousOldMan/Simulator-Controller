...
[6.5.5.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/n4W-LbZo) (Test version for 6.5.5. Changes: Full support for the new R3E API, New (synthetical) event "plan_pitstop" for the *Reasoning* booster of the Race Engineer, Fixed missing translations, Fixed language specific instruction storage, New (synthetical) event "recommend_pitstop" for the *Reasoning* booster of the Race Strategist, New internal action "recommend_pitstop" for the *Reasoning* booster of the Race Strategist, Support for AC timed races.)
