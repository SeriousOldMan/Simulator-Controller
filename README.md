...
[5.7.0.0-release](https://cutt.ly/9eqX8slu) (Changes: Added overtaking threshold gap for the Spotter, Rearranged info priority for the Spotter, New speech processor library for speech pre- and post-processing, Added speech post-processor configuration to "Simulator Setup", Fine-tuning of accident detection for extreme braking zones.)
