...
|          | LogSimulator | False | If *True*, special logging is enabled which gives you insights into the data acquisition using the simulator API. Warning: This generates a lot of logging output and will slow things down considerable. |
