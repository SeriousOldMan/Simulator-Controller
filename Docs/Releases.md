...
## 6.2.1.0-release 02/27/25 (planned)
  1. Minor bugfixes, as always
  2. Documentation updates here and there, as always
  ...
  10. Increased resilience against corrupted telemetry layout definitions. Still do not understand, why theey get corrupted in the first place.
  ...
  12. Straights can now be given names as well in track maps.
  ...
  14. Several default values have been changed for simulator specific settings in "Simulator Setup" and "Simulator Configuration" to make initial configuration more *friendly* for novices.
