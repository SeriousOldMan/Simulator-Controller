...
[7.2.5.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/-y_FQ8dY?inline=true) (Test build for 7.2.5. Changes: New car models for "Setup Workbench", Fixed Driving Coach reference lap saving, Update R3E car database, Fixed wrong car names for ACE, Show more undriven cars in "Setup Workbench", Fixed overlong car names for ACE, Fixed RawHandler in "Setup Workbench", Max increment setting for setup changes.)
