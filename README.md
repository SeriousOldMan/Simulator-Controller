...
[6.8.3.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/b1XQWRSY/Releases/Simulator%20Controller%206.8.3.0-dev.zip) (Early build for 6.8.2. Changes: Team Server as DLC, Whisper Server as DLC, New car models for "Setup Workbench", Fixed tyre set computations for sims not supporting it.)
