...
[6.2.6.0-release]() (Changes: Fixed several UTF encoding problems for driver names in the session database, Integrated Lua as scripting language, New core settings for folder locations, New resizing rules for "Strategy Workbech", Fixed several translation errors.)
