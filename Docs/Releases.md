## 5.5.8.0-release 02/16/24 (planned)
  ...
  10. The Stream Deck icons now show a small colored bar at their top for toggleable controller actions to indicate, whether the corresponding function is actived, deactivaed or not available at all.
