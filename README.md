...
[6.6.7.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/QTXOzBy5/Releases/Simulator%20Controller%206.6.7.0-dev.zip) (Early build for 6.6.7. Changes: Support for Hello/Hallo in activation phrase, Increased stability of MoTeC importer, New generic CSV telemetry importer, Default for community sharing.)
