## 5.5.5.0-release 01/26/24 (planned)
  ...
  4. Several improvements for the "Setup Workbench", which now supports many more unconventional setup options and is fully prepared to handle hybrid cars with electrical power units and energy recovery systems:
