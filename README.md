...
[6.8.5.0-dev](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/Iw4hU5Gw/Releases/Simulator%20Controller%206.8.5.0-dev.zip) (Early build for 6.8.5. Changes: Refactord voice continuations, Fixed track deletion for LMU in "Session Database", Car classes for LMU, New gap calculation for AC ACC AMS2 PCARS2 R3E and PMR, Removed missing information from "System Monitor" in first lap.)
