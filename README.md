...
[6.1.5.0-beta]() (Test build for 6.1.5. Changes: Fixed handling of team tab in "Race Settings", Fixed crash in "Setup Workbench" for special characters in car names, Fixed default for pitlane delta default value when not set, Up 2 date info for fuel, tyres and brakes by the Engineer, Fixed display of cold pressures in "Team Center" lap data, More checks in Controller layout editor, Special editor for validation rules in "Setup Workbench", Support for Inner, Middle and Outer tyre temperatures for iRacing, Fixed a bug in Azure voice recognition, Added Manifest Information.)
