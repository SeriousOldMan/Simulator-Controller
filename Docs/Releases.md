...
#### Changes
  ...
  - The Engineer can now decide based on tyre wear data which will be the best tyre compound mixture when changing tyres for the next stint.
	...
	- More details can be found in the [extended documentation](https://github.com/SeriousOldMan/Simulator-Controller/wiki/AI-Race-Engineer#how-it-works) for the Race Engineer and for [tyre compound handling](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Tyre-Compounds#usable-life-of-a-tyre-compound) in general.
