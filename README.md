...
[7.2.6.0-beta]() (Test build for 7.2.6. Changes: Fixed standings and gap calculation for iRacing, Potential fix for team session handover for LMU, Optimized telemetry startup in "Solo Center", Caching for track spline for ACC, Wildcard matching for setup settings in car rules, New car models for "Setup Workbench".)
