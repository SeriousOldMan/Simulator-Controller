...
| setMode | mode | Builtin | Switches the currently active mode for the hardware controller. See the [plugin reference](*) for an in depth explanation of all available modes. |
