...
[6.2.8.0-release](https://cutt.ly/zrgkRcgP) (Changes: New profile dialog in "Simulator Startup", New diagnostics system, Support for multiple P2T keys, Tweaked news system again, Fixed argument processing in script callbacks, Fixed execution of custom conversation actions, New core settings for Lua search paths.)
