...
[5.7.2.0-dev](https://cutt.ly/7eePpLge) (Early build for 5.7.2. Changes: New telemetry instruction for the Driving Coach, General conversation capability for all Assistants using GPT technology, Fixed installation of French language pack, Conversation Booster configuration integrated in "Simulator Configuration", Added "Mistral AI" as GPT service provider, Added "GPT-4o" model entry.)
