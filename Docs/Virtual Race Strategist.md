...
Notes:
  ...
  2. If you have to perform a number of required pitstops, the minimum allowed value here is **2**. If there is only one required pitstop, either use the window rule, or set the pitstop setting to "Optional", but choose either "Refuel" and/or "Tyre Change" as required.
