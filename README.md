...
[7.1.2.0-release]() (Test build for 7.1.2. Changes: Tool calling for LLM Runtime, New core settings for the LLM Runtime, Answer post processing for the booster, Fixed loading of custom cars in "Setup Workbench".)
