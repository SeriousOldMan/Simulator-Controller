## 5.9.9.0-release 11/22/24 (planned)
  ...
  4. The community sharing consent can now be changed in the settings dialog of the "Session Database".
  5. A new version of the local LLM Runtime is available, which includes the llama backend.
