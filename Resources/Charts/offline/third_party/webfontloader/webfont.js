...
;(function(window, document, undefined) {
    ...
    ;function D(a, b, c, d, e, f, g, h, k, p, s) {
        this.K = a;
        this.Ga = b;
        this.za = c;
        this.fa = d;
    ...
    E.prototype.parse = function() {
        ...
        if (-1 != this.a.indexOf("MSIE") || -1 != this.a.indexOf("Trident/")) {
            ...
            g = new B,
            h = "Unknown");
            a = new D("MSIE",e,d,f,g,h,a,c,b,k,new A("Windows" == a && 6 <= e.d || "Windows Phone" == a && 8 <= c.d,m,m))
            ...
            e = C(d),
            f = I(this.I),
            c.d !== l ? a = "Presto" : (-1 != this.a.indexOf("Gecko") && (a = "Gecko"),
            b = H(this.a, /rv:([^\)]+)/, 1),
            c = C(b)),
            -1 != this.a.indexOf("Opera Mini/"))
                g = H(this.a, /Opera Mini\/([\d\.]+)/, 1),
                h = C(g),
                a = new D("OperaMini",h,g,a,c,b,F(this),e,d,f,new A(m,m,m));
            else {
                if (-1 != this.a.indexOf("Version/") && (g = H(this.a, /Version\/([\d\.]+)/, 1),
                h = C(g),
                h.d !== l)) {
                    a = new D("Opera",h,g,a,c,b,F(this),e,d,f,new A(10 <= h.d,m,m));
                    break a
                }
                g = H(this.a, /Opera[\/ ]([\d\.]+)/, 1);
                h = C(g);
                a = h.d !== l ? new D("Opera",h,g,a,c,b,F(this),e,d,f,new A(10 <= h.d,m,m)) : new D("Opera",new B,"Unknown",a,c,b,F(this),e,d,f,new A(m,m,m))
            }
        else
            /OPR\/[\d.]+/.test(this.a) ? a = ha(this) : /AppleWeb(K|k)it/.test(this.a) ? a = ha(this) : -1 != this.a.indexOf("Gecko") ? (a = "Unknown",
            b = new B,
            c = "Unknown",
            d = G(this),
            e = C(d),
            ...
            b = C(c),
            f = 3 <= b.d && 5 <= b.o) : -1 != this.a.indexOf("Mozilla") && (a = "Mozilla"),
            g = H(this.a, /rv:([^\)]+)/, 1),
            h = C(g),
            f || (f = 1 < h.d || 1 == h.d && 9 < h.o || 1 == h.d && 9 == h.o && 2 <= h.aa || g.match(/1\.9\.1b[123]/) != l || g.match(/1\.9\.1\.[\d\.]+/) != l),
            a = new D(a,b,c,"Gecko",h,g,F(this),e,d,I(this.I),new A(f,m,m))) : a = ga;
        return a
    }
    ;
    function F(a) {
    ...
    function ha(a) {
        ...
        "BuiltinBrowser" == g ? k = "Unknown" : "Silk" == g ? k = H(a.a, /Silk\/([\d\._]+)/, 1) : "Chrome" == g ? k = H(a.a, /(Chrome|CrMo|CriOS)\/([\d\.]+)/, 2) : -1 != a.a.indexOf("Version/") ? k = H(a.a, /Version\/([\d\.\w]+)/, 1) : "AdobeAIR" == g ? k = H(a.a, /AdobeAIR\/([\d\.]+)/, 1) : "Opera" == g ? k = H(a.a, /OPR\/([\d.]+)/, 1) : "PhantomJS" == g && (k = H(a.a, /PhantomJS\/([\d.]+)/, 1));
        h = C(k);
        p = "AdobeAIR" == g ? 2 < h.d || 2 == h.d && 5 <= h.o : "BlackBerry" == b ? 10 <= d.d : "Android" == b ? 2 < d.d || 2 == d.d && 1 < d.o : 526 <= f.d || 525 <= f.d && 13 <= f.o;
        return new D(g,h,k,"AppleWebKit",f,e,b,d,c,I(a.I),new A(p,536 > f.d || 536 == f.d && 11 > f.o,"iPhone" == b || "iPad" == b || "iPod" == b || "Macintosh" == b))
    }
    function H(a, b, c) {
    ...
    function na(a, b, c, d, e, f, g, h) {
        ...
        Q(a);
        for (var k in R)
            R.hasOwnProperty(k) && (P(a, new J(R[k],K(this.q))),
    ...
    function pa(a) {
        var b = a.A.s.offsetWidth
          , c = a.B.s.offsetWidth;
        b === a.F.serif && c === a.F["sans-serif"] || a.k.U && qa(a, b, c) ? u() - a.xa >= a.T ? a.k.U && qa(a, b, c) && (a.Z === l || a.Z.hasOwnProperty(a.q.getName())) ? S(a, a.W) : S(a, a.sa) : setTimeout(t(function() {
            pa(this)
        }, a), 25) : S(a, a.W)
    }
    function S(a, b) {
    ...
    function ra(a, b, c, d, e) {
        if (0 === b.length && e)
            ...
            for (e = 0; e < b.length; e++) {
                ...
                L(h, "fontloading", k);
                (new na(t(a.ga, a),t(a.ha, a),a.c,f,a.k,a.T,d,g)).start()
            }
        }
    }
    ...
    ;
    function sa(a) {
        0 == --a.P && a.Y && (a.ba ? (a = a.t,
        x(a.h, a.g.f(a.j, "loading")),
        x(a.h, a.g.f(a.j, "inactive")),
        w(a.h, a.g.f(a.j, "active")),
        L(a, "active")) : M(a.t))
    }
    ;function U(a) {
        this.G = a;
    ...
    U.prototype.load = function(a) {
        ...
        var b = new ka(this.c,b.document.documentElement,a), c = this.u, d = this.c, e = [], f;
        for (f in a)
        ...
        a = a.timeout;
        this.Q = this.R = e.length;
        a = new T(this.a,this.c,b,a);
        f = 0;
        for (c = e.length; f < c; f++)
            d = e[f],
            d.H(this.a, t(this.ta, this, d, b, a))
    }
    ;
    ...
    var ua = "//fonts.googleapis.com/css";
    ...
    var wa = {
      ...
      , za = RegExp("^(thin|(?:(?:extra|ultra)-?)?light|regular|book|medium|(?:(?:semi|demi|extra|ultra)-?)?bold|black|heavy|l|r|b|[1-9]00)?(n|i|normal|italic)?$");
    va.prototype.parse = function() {
        for (var a = this.p.length, b = 0; b < a; b++) {
            ...
            if (2 <= c.length) {
                ...
                f = [];
                if (g)
                    for (var g = g.split(","), h = g.length, k = 0; k < h; k++) {
                        var p;
                        p = g[k];
                        if (p.match(/^[\w]+$/)) {
                            p = za.exec(p.toLowerCase());
                            var s = void 0;
                            if (p == l)
                                s = "";
                            else {
                                ...
                                if (s == l || "" == s)
                                    ...
                                    var oa = xa[s]
                                      , s = oa ? oa : isNaN(s) ? "4" : s.substr(0, 1);
                                s = [p[2] == l || "" == p[2] ? "n" : ya[p[2]], s].join("")
                            }
                            p = s
                        } else
                            p = "";
                ...
                f = [],
                c = !c ? f : c.split(","),
                0 < c.length && (c = wa[c[0]]) && (this.J[d] = c))
            }
            this.J[d] || (c = wa[d]) && (this.J[d] = c);
    ...
    W.prototype.X = function(a) {
        for (var b = this.c, c = new ta(this.e.api,y(b),this.e.text), d = this.e.families, e = d.length, f = 0; f < e; f++) {
            var g = d[f].split(":");
            3 == g.length && c.S.push(g.pop());
            var h = "";
            2 == g.length && "" != g[1] && (h = ":");
            c.p.push(g.join(h))
        }
    ...
    X.prototype.load = function(a) {
        ...
        for (c = e.length; b < c; b++) {
            var g = e[b].split(":");
            if (g[1])
                for (var h = g[1].split(","), k = 0; k < h.length; k += 1)
                    d.push(new J(g[0],h[k]));
            else
                d.push(new J(g[0]))
        }
        a(d, f)
