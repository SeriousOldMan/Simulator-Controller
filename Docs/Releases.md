## 4.5.9.0-release 02/10/23 (planned)
  ...
  10. Setting for [pressure loss correction in pitstop initialization](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Team-Server#planning-a-pitstop) in "Race Center".
