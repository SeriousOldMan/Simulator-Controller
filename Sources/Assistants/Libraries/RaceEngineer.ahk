...
class RaceEngineer extends RaceAssistant {
	...
	getKnowledge() {
		...
		local bodyworkDamage, suspensionDamage, engineDamage, bodyworkDamageSum, suspensionDamageSum
		...
		if (knowledge && knowledgeBase) {
			...
			tyres["TyreSet"] := knowledgeBase.getValue("Lap." . lapNumber . ".Tyre.Set", false)
			tyres["Pressures"]
