...
#### Changes
  ...
  - Support for the new shared memory API of *Le Mans Ultimate* has been added.
	...
	- More important, information about TC and ABS activations is now available in the telemetry data, thereby enabling the Driving Coach to give you more precise hints for cornering and car handling.
