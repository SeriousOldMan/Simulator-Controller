...
Important: Please be sure to read the [update notes on Release 2.4](https://github.com/SeriousOldMan/Simulator-Controller/wiki/Update-Notes#release-24), before using the build.
