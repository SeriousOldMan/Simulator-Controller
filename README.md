...
[6.9.5.0-beta](https://fileshare.impresion3d.pro/filebrowser/api/public/dl/12sYIXZL/Releases/Simulator%20Controller%206.9.5.0-beta.zip) (Test build for 6.9.5. Changes: Logging for simulator data acquisition, Support for the new LMU API, New core settings for LMU API, Performance optimizations for LMU API.)
